...
function Home() {
    ...
    return ( <
        ...
        id = 'landing'
        style = {
            { background: `url(${landing_bg}) 75% 100%` }
        } >
        <
        ...
        <
        Project title = 'E-Commerce Website like amazon'
        ...
        div className = 'projects' >
        <
        Project title = 'Mad Libs Generator'
        ...
        div className = 'projects' >
        <
        Project title = 'JavaScript Music Events'
        ...
        rating = { 4 }
        /> <
        Project title = 'JavaScript Form Validation'
        ...
        rating = { 4 }
        /> <
        Project title = 'Build a Shopping Cart for Order Fulfillment'
